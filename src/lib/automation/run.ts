...
// Ejecuta todas las automatizaciones del sistema: recordatorios de facturas,
// auto-contacto de leads, informes mensuales, reseñas y borradores IA.
// Diseñado para correr tanto desde /api/automation (cron 09:00) como desde el
// lead scraper (cron 07:00) para que la automatización nunca dependa de un
// único scheduler.
export async function runAutomationFull(now = new Date()): Promise<AutomationResult> {
  ...
  try {
    ...
    //    seguimiento rotativo de los ya contactados
